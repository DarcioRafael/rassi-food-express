...
export default function Lojas(props: LojasProps) {
    ...
    const key = '@App:Lojas'; // Chave para armazenar os dados no AsyncStorage
    ...
    const getLojas = async (value: object) => {// Função para obter os dados do AsyncStorage
        try {// alert(`Cheguei em getLojas`);
            // console.log(value)
        ...
        } catch (e) {// alert(`Dados não encontrado.`);
            console.error('Erro ao atualizar dados:', e);// alert(`Dados não encontrado.`);
        }
    }
